...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two Strings as its argument.
     *
     * @param firstString a string for this Silly instance's name.
     * @param secondString a string for this Silly instance's name
     */
